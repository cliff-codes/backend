...
const swaggerJsdoc = (swaggerJsdocNS as any).default || swaggerJsdocNS;
const swaggerUi = (swaggerUiNS as any).default || swaggerUiNS;

const options: swaggerJsdocNS.Options = {
    definition: {
        openapi: '3.0.0',
        info: {
